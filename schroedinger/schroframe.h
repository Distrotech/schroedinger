...
#include <schroedinger/schroaux.h>
...
struct _SchroFrame {
  ...
  uint16_t timecode_mask;
  SchroAuxTimeCode timecodes[16];
};
...
void schro_frame_set_timecode (SchroFrame *frame, SchroAuxTimeCode *timecode);
