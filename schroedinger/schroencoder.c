...
{
  SchroBuffer *buffer;
  buffer = schro_aux_encode_encoder_comment();
...
schro_encoder_encode_end_of_stream (SchroEncoder *encoder)
{
  ...
  schro_bits_encode_parse_info (bits, SCHRO_PARSE_CODE_END_SEQUENCE);
...
schro_encoder_encode_picture (SchroEncoderTask *task)
{
  ...
  /* encode header */
  schro_bits_encode_parse_info (task->bits,
    ...
    SchroBits *bits)
{
  ...
  schro_bits_encode_parse_info (bits, SCHRO_PARSE_CODE_ACCESS_UNIT);
